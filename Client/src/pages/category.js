...
//   };
  return (
    ...
    //           <div className={`${slug == 'truyen-moi'? "bg-[#E6F4FF] text-[#1677FF]":""} hover:bg-[#F0F0F0] rounded-xl w-[90%] m-auto p-3 cursor-pointer 
    ...
    //             Truyện mới
    //           </div>
    //           <div className={`${slug == 'sap-ra-mat'? "bg-[#E6F4FF] text-[#1677FF]":""} hover:bg-[#F0F0F0] rounded-xl w-[90%] m-auto p-3 cursor-pointer 
    //           flex gap-2 items-center laptop:mt-5 phone:mx-3 laptop:mx-2`}
    ...
    //             Sắp ra mắt
    //           </div>
    //           <div className={`${slug == 'dang-phat-hanh'? "bg-[#E6F4FF] text-[#1677FF]":""}  hover:bg-[#F0F0F0] rounded-xl w-[90%] m-auto p-3 cursor-pointer 
    //           flex gap-2 items-center laptop:mt-5 phone:mx-3 laptop:mx-2`}
    ...
    //             Đang phát hành
    //           </div>
    //           <div className={`${slug == 'hoan-thanh'? "bg-[#E6F4FF] text-[#1677FF]":""}  hover:bg-[#F0F0F0] rounded-xl w-[90%] m-auto p-3 cursor-pointer 
    //           flex gap-2 items-center laptop:mt-5 phone:mx-3 laptop:mx-2`}
...
//   return (
//       <figure className='h-52 mr-4 relative cursor-pointer' key={item._id}>
...
//                   <p><FontAwesomeIcon icon={faEye} />{item.views} </p>
//               </div>
//           </div>
//           <div>
//               <p className={`${darkMode ? "text-[#CCCCCC]" : "text-black "} font-semibold mt-3`}>{item.name.slice(0,14)} ...</p>
//           </div>
//           {item.nomarl ?
//               <button className="promotion-button w-fit p-1 m-1 bg-primary-color text-white text-xs shadow-md rounded-md font-medium absolute top-1 left-1">{item.time}</button>
//               : ''
//           }
//           {item.hot ?
//               <button className="hot-button w-2/6 h-[10%] bg-[#FF4500] text-white text-xs shadow-md rounded-md font-medium uppercase absolute top-1 right-1">Hot</button>
//               : ''
//           }
//       </figure>
//   );
